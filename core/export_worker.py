...
class ExportWorker(QThread):
    ...
    # SE AGREGO section_styles AL CONSTRUCTOR
        ...
        try:
            ...
            with concurrent.futures.ThreadPoolExecutor(max_workers=cores) as executor:
                for i in range(cores):
                    ...
                    futures.append(
                        executor.submit(self._render_chunk, i, start_f, end_f, temp_file, bg_is_video)
                    )
    ...
    def _render_chunk(self, chunk_id, start_frame, end_frame, temp_file, bg_is_video):
        ...
        render_tex = ctx.texture((1920, 1080), 4)
        fbo = ctx.framebuffer(color_attachments=[render_tex])
        ...
        for frame_idx in range(start_frame, end_frame):
            ...
            # GESTION DINAMICA DE TEXTURA PARA EVITAR CRASHES POR TAMANO
            ...
            if active_segment and active_segment.get("words"):
                # GESTION DINAMICA DE SECCIONES (VERSO, CORO, ETC)
                ...
                anim_state = animator.process_segment(active_segment, current_time, bass, mid, high)
                
                # INYECTAR COLOR EN EL MOTOR DE TEXTO
            ...
            # GESTION DEL MOVIMIENTO DE CAMARA
